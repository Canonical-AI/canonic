// Line-based unified diff (CommonJS) for the main process / MCP server.
// Mirrors the renderer's src/utils/diff.js — kept as a separate CJS copy because
// the MCP server can't import the ESM renderer module. Keep the two in sync.
...
function generateDiff(before, after, contextLines = 3) {
...
module.exports = { buildOps, countDiff, generateDiff }
