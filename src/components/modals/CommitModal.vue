    ...
    <div class="modal-backdrop" @click.self="$emit('close')">
        <div class="modal">
            ...
            <p class="modal-subtitle">
                ...
                <strong>{{ store.currentFile }}</strong> to history.
            </p>
            ...
            <div class="diff-section">
                <div class="diff-header">
                    <span class="diff-header-label"
                        >Changes since last checkpoint</span
                    >
                    <span v-if="diffLoading" class="diff-loading"
                        >loading…</span
                    >
                ...
                <p v-else-if="!diffLoading" class="diff-empty">
            ...
            <div class="field">
                ...
                />
                <p class="field-hint">
                    Describe what changed or why this checkpoint matters.
                </p>
            </div>
...
onMounted(async () => {
    try {
        ...
        const workingContent = store.isDirty
            ...
            : await window.canonic.files.read(
                  store.workspacePath,
                  store.currentFile,
              );
        let headContent = "";
